...
@ActiveProfiles("dev")
@ContextConfiguration(locations = { "classpath:com/spring/web/config/dao-context.xml",
		"classpath:com/spring/web/config/security-context.xml", "classpath:com/spring/test/config/datasource.xml" })
...
public class NoticesDaoTest {
	...
	@Autowired
	private UserDao usersDao;// this variable would be userDao
