# Lacture 122-123
## Objective : Using Spring Profiles (changed dao-context & web.xml)
...
# Lacture 124
## Objective : JUnit Tests (Create new source folder test)
...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<beans profile="dev">
		<context:property-placeholder
			location="com/spring/test/config/jdbc.properties" />
		<context:component-scan base-package="com.livingoncodes.spring.springtutorial">
...
```properties
	...
	jdbc.url = jdbc:mysql://localhost:3306/springtest?useSSL=false
```
...
# Lacture 145
## Objective : Coding the JUnit Dao tests
